...
<div style="height: -webkit-fill-available; padding-bottom: 0; background-color: #00373e;border-radius: 30px; margin-top: 30px; overflow-y: auto; position: relative">
    <!-- App Header -->
    ...
    <!-- * App Capsule -->
    <div id="toast-1" class="toast-box toast-bottom" style="justify-content: center;border-radius: 100% 100% 0 0;">
