                                        ...
                                        <div class="card" style="padding: 7px 0 7px 0; background-color: transparent">
                                            <div class="card-body" style="padding: 0">
                                                <div class="container" style="padding: 0px 5px 0px">
                                                    ...
                                                    <div class="row" >
                                                        <div class="col" style="padding: 0">
                                                            <strong style="font-size: 20px; color: black;"><span style="color: @if($match['score_fulltime_home'] > $match['score_fulltime_away']) #51b115 @endif">{{ $match['score_fulltime_home'] }}</span> - <span style="color: @if($match['score_fulltime_home'] < $match['score_fulltime_away']) #51b115 @endif">{{ $match['score_fulltime_away'] }}</span></strong>
                                                        </div>
                                                    </div>
                                                </div>
